<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h3 class="text-lg font-medium mb-4">Sales for the Last 7 Days</h3>
    ...
    <script>
        ...
        const salesChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: {!! json_encode(array_keys($salesByDay)) !!},
                datasets: [{
                    label: 'Daily Sales',
                    data: {!! json_encode(array_values($salesByDay)) !!},
